(function ($) {
  ...
  function makeTimer() {
    ...
    var endTime = new Date("31 January 2023 23:59:59 GMT+08:00");
    ...
    $("#days").html("<span>剩餘天數</span>" + days);
    $("#hours").html("<span>小時</span>" + hours);
    $("#minutes").html("<span>分</span>" + minutes);
    $("#seconds").html("<span>秒</span>" + seconds);
